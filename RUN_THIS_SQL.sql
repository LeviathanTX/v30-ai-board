-- V24 to V30 Complete Advisor Migration
-- Run this in Supabase SQL Editor (bypasses RLS)

-- Step 1: Remove existing default advisors
DELETE FROM advisors WHERE is_custom = false;

-- Step 2: Insert complete enhanced advisor set

-- V30 Core Team (6 advisors) - Enhanced
...
-- V24 Celebrity Advisors (8 advisors) - Added
('00000000-0000-0000-0000-000000000007', 'Mark Cuban', 'Entrepreneur & Investor',
...
('00000000-0000-0000-0000-000000000008', 'Jason Calacanis', 'Angel Investor & Podcaster',
...
('00000000-0000-0000-0000-000000000009', 'Sheryl Sandberg', 'Operations & Leadership Expert',
...
('00000000-0000-0000-0000-000000000010', 'Ruth Porat', 'CFO & Finance Expert',
...
('00000000-0000-0000-0000-000000000011', 'Tim Cook', 'CEO & Operations Expert',
...
('00000000-0000-0000-0000-000000000012', 'Marc Benioff', 'CEO & Cloud Computing Pioneer',
...
('00000000-0000-0000-0000-000000000013', 'Satya Nadella', 'CEO & Digital Transformation Leader',
...
('00000000-0000-0000-0000-000000000014', 'Reid Hoffman', 'Founder & Network Strategy Expert',
