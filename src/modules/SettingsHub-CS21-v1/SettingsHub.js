...
import { renderEnhancedAiServicesSettings } from './SettingsHub-enhanced';
...
export default function SettingsHub() {
  ...
  const renderAiServicesSettings = () => {
    return renderEnhancedAiServicesSettings(aiServices, setAiServices, voiceServices, setVoiceServices, dispatch, actions);
  };
